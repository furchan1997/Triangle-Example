...
function HomePage() {
  ...
  return (
    ...
    <div className="d-flex flex-column justify-content-center align-items-center">
      ...
      <p>
        הנה גרסה מותאמת כאילו אתה מציג את זה למשתמשים, בשפה פשוטה וזורמת: זהו
        יישום אינטראקטיבי שבו תוכלו להזין שלוש נקודות במערכת צירים (ערכי X ו־Y)
        ולראות מיד איך נוצר מהן משולש על המסך. האפליקציה כוללת שני מסכים:
      </p>
